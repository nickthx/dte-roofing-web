...
Last activity: 2026-06-06 - Completed quick task 260606-knp: interaction-load Roofle slideout + remove dead Supabase client (LH mobile 60→80, LCP 6.9→4.7s); commits local, not pushed
