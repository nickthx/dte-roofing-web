...
Last activity: 2026-09-22 - Completed quick task 260922-h4n: aligned homepage WebPage schema `name` with the `<title>` tag (`src/pages/Home.tsx:32`, one-line change, commit 5d46b54, build clean). Not yet pushed — push to main to deploy.
