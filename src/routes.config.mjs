...
export const ROUTES = [
  ...
  { path: '/services/preventative-maintenance', source: 'src/pages/services/PreventativeMaintenance.tsx', changefreq: 'monthly', priority: '0.8', prerender: true },
  ...
  { path: '/blog/roof-replacement-cost-columbus-ohio', source: 'src/data/posts/roof-replacement-cost-columbus-ohio.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
  { path: '/blog/asphalt-vs-metal-roofing-ohio', source: 'src/data/posts/asphalt-vs-metal-roofing-ohio.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
  { path: '/blog/hail-damage-roof-insurance-claim-ohio', source: 'src/data/posts/hail-damage-roof-insurance-claim-ohio.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
  { path: '/blog/how-long-does-a-roof-last-ohio', source: 'src/data/posts/how-long-does-a-roof-last-ohio.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
  { path: '/blog/roof-repair-vs-replacement', source: 'src/data/posts/roof-repair-vs-replacement.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
  { path: '/blog/what-to-look-for-columbus-roofing-contractor', source: 'src/data/posts/what-to-look-for-columbus-roofing-contractor.tsx', changefreq: 'monthly', priority: '0.6', prerender: true },
