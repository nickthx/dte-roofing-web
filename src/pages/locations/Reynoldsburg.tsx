...
export default function Reynoldsburg() {
  ...
  const reynoldsburgFaqs = [
    {
      question: "Do you serve Reynoldsburg if you're based in Columbus?",
      answer: "Absolutely. We're based at 615 Hilliard Rome Rd, Columbus, OH 43228, and serve Reynoldsburg regularly on the east and southeast side of Columbus. Distance has never been an issue—we know the routes (I-270, I-70, East Main/US-40, Livingston Ave corridors) and respond efficiently to all Reynoldsburg areas from downtown to Blacklick Creek to neighborhoods near Pickerington and Canal Winchester borders."
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <LocationBreadcrumb cityName="Reynoldsburg" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {reynoldsburgFaqs.map((faq, index) => (
          ...
          <NearbyAreas locationSlug="reynoldsburg" />
